...
//public class SettingsCommon : ObservableObject {
//    var id = UUID()
...
//    @Published public var colorScore = UIGlobals.colorScoreDefault
//    @Published public var colorInstructions = UIGlobals.colorInstructionsDefault
